...
const checkLine = (a, b, c) => {
  // returns when they are all equal to the next value AND whether playBoard[a] equals player or cpu
   return (
...
const checkForWinner = () => {
  ...
  if (res == player ){
    gameStatus.innerText = "You are the winner!";
    gameStatus.classList = 'player-winner';
    boardFull = true;
...
const resetBoard = () => {
  ...
  playBoard = ["", "", "", "", "", "", "", "", ""];
  boardFull = false;
  gameStatus.classList.remove('player-winner');
  gameStatus.classList.remove('computer-winner');
